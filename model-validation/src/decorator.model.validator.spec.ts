...
describe('DecoratorModelValidator', () => {
  ...
  describe('validateMember', () => {
    ...
    it('validates complex types with validateModel', () => {
      ...
      validator.validateMember({ type: TestModel }, 'prop', {
        prop1: 'foo',
        prop2: 'bar',
      });

      expect(validator.validateModel).to.have.been.calledOnce.calledWithExactly(
        TestModel,
        { prop1: 'foo', prop2: 'bar' },
        'prop',
      );
    ...
    describe('arrays', () => {
      it('validates each of the array members using the array subtype', () => {
        ...
        expect(primitiveTypeValidator.validate)
