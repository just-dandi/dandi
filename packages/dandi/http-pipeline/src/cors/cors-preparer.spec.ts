...
import { CorsAllowRequest, CorsHeaderValues, CorsPreparer, corsRequestAllowed } from '@dandi/http-pipeline'
...
describe('CorsPreparer', () => {
  ...
  describe('prepare', () => {
    it(
      'returns a CorsAllowRequest factory provider that determines whether the request will be allowed by CORS rules if ' +
        'the request is a CORS request',
      async () => {
